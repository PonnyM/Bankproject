...
#         user=User_Accounts.objects.create(
#             firstname = firstname,
#             lastname = lastname,
#             username = username,
#             email = email,
...
#             message=f"Hi {username}, your signup is successful.",
#             from_email="ponnymanichn@gmail.com",
#             recipient_list=[email],
#             fail_silently=False,
#         )

#         print(messages.success(request, "Signup successful! Email sent."))
